...
This public repository contains the core detector, one example input, and assistant skills. It does not contain the raw research datasets, historical model outputs, evaluation artifacts, or all materials needed to reproduce paper experiments.
